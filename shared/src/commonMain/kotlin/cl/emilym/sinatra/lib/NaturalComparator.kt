...
fun <T: CharSequence> naturalComparator(): Comparator<T> = NaturalComparator()

// https://github.com/MajorTanya/kotlin-natural-sort
private class NaturalComparator<T : CharSequence> : Comparator<T> {
    ...
    fun compareChars(c1: Char, c2: Char): Int = c1.code - c2.code
