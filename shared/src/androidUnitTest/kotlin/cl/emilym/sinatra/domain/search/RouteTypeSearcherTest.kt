...
class RouteTypeSearcherTest {
    ...
    fun `scoreMultiplier should return 1_7 when colors is not null`() {
        // Arrange
        val route = Route("1", "Route Name", "Display Code", ColorPair("FFFFFF", OnColor.LIGHT), "Test", false, RouteType.BUS, null, RouteVisibility(false, null))
    ...
    fun `scoreMultiplier should return 0_2 when name is NIS`() {
        // Arrange
        val route = Route("1", "Route Name", "Display Code", null, "NIS", false, RouteType.BUS, null, RouteVisibility(false, null))
    ...
    fun `scoreMultiplier should return 1_1 for other cases`() {
        // Arrange
        val route = Route("1", "Route Name", "Display Code", null, "Test", false, RouteType.BUS, null, RouteVisibility(false, null))
